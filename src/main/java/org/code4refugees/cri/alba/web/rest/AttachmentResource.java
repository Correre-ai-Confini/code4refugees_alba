...
/**
 * REST controller for managing {@link org.code4refugees.cri.alba.domain.Attachment}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Attachment> partialUpdateAttachment(
        ...
        Optional<Attachment> result = attachmentRepository
            ...
            .map(existingAttachment -> {
                ...
                if (attachment.getCreationTS() != null) {
                    existingAttachment.setCreationTS(attachment.getCreationTS());
                }
                if (attachment.getName() != null) {
                    existingAttachment.setName(attachment.getName());
                }
                if (attachment.getContentBlob() != null) {
                    existingAttachment.setContentBlob(attachment.getContentBlob());
                }
                if (attachment.getContentBlobContentType() != null) {
                    existingAttachment.setContentBlobContentType(attachment.getContentBlobContentType());
                }
