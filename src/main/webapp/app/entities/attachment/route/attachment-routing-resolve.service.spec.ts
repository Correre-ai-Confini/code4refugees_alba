...
describe('Attachment routing resolve service', () => {
  ...
  let resultAttachment: IAttachment | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IAttachment if id is not provided', () => {
      // GIVEN
      ...
      expect(resultAttachment).toEqual(new Attachment());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Attachment })));
      mockActivatedRouteSnapshot.params = { id: 123 };
