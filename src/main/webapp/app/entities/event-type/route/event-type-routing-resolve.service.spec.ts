...
describe('EventType routing resolve service', () => {
  ...
  let routingResolveService: EventTypeRoutingResolveService;
  let service: EventTypeService;
  let resultEventType: IEventType | undefined;
  ...
  beforeEach(() => {
    ...
    routingResolveService = TestBed.inject(EventTypeRoutingResolveService);
  ...
  describe('resolve', () => {
    ...
    it('should return new IEventType if id is not provided', () => {
      // GIVEN
      ...
      expect(resultEventType).toEqual(new EventType());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as EventType })));
      mockActivatedRouteSnapshot.params = { id: 123 };
