...
describe('Operator routing resolve service', () => {
  ...
  let resultOperator: IOperator | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IOperator if id is not provided', () => {
      // GIVEN
      ...
      expect(resultOperator).toEqual(new Operator());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Operator })));
      mockActivatedRouteSnapshot.params = { id: 123 };
